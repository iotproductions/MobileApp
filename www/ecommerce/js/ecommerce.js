...
var charSeparator = ".";
// var AppCode = AppCodeMK; // Edit 16/10/2018
var KeyNumberCartItem = AppCode + "NumberCartItem";
var KeyCartItems = AppCode + "CartItems";
var RAPInfo;
//var LangCode = localStorage.getItem(AppCode + KeyLocalEcom.ItemLanguage);;// Edit 16/10/2018
var LanguageEcom;
// Load Javascript
...
app.controller("companyctrl",function($scope){
    var lcode =LangCode;// localStorage.getItem(AppCode + KeyLocalEcom.ItemLanguage);
    ...
    {
        PushToPage("ecommerce/catemain.html");
    }
});
...
app.controller('catemainctrl', function ($scope, $rootScope) {
    ...
    //     ResetToPage(path_html_mk+"/main.html");
    // }
...
function ShowToastEcommerce(message, animation, timeout, classname, callbackfunction) {
    ...
    if (animation == null && ons.platform.isIOS()) {
...
app.controller("ecommercenotificationsctrl", function ($scope) {
    ...
    $scope.Page = 1;
    $scope.PageLimit = 20;
    GetListNotificationEcommerce(RAPInfo.CustomerCode, AppCode, $scope.Page, $scope.Pagelimit, function (result) {
        if (result != null) {
            if (result.success == true) {
...
function GetListNotificationEcommerce(CustomerCode, AppCode, Page, PageLimit, callback) {
    $.ajax({
        url: ipEcommerce + "/Notification/GetListNotificationEcommerceByCusCode",
        type: "GET",
        dataType: "JSON",
        data: {
            CustomerCode: CustomerCode,
